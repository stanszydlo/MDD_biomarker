...
#
#                       MDD Differential Expression Analysis:
...
# Two sample t-test with equal variance .........................................
  ...
  # Assign class label (0 == CNTL, 1 = MDD)
  pcnorm_cl <- as.integer(demog$mdd)
...
# Feature Selection ...........................................................
  ...
  # sort probes by ascending q-value
  probes_q <- data.frame(probes, q_value = qobj$qvalues)[order(qobj$qvalues),]
  probes_q$probes <- sapply(probes_q$probes , as.character) 
  
  #write_csv(probes_q, "data/mdd_probes_q.csv")
